  ...
  return (
    <div className="bg-gray-900">
      ...
      <div className="relative isolate overflow-hidden pt-14">
        ...
        /> */}
        <div
          className="absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden sm:-top-60"
          aria-hidden="true"
        >
          <video
            // className="relative left-[calc(50%-50rem)] w-[85.125rem] sm:left-[calc(50%-27rem)] sm:w-[72.1875rem]"
            className="relative left-[calc(50%-50rem)] w-full sm:left-[calc(50%-27rem)] sm:w-full sm:h-full"
            controls
            ref={videoRef}
            autoPlay
            loop
